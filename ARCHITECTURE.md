...
6. [Gameplay surface (architectural view)](#gameplay-surface-architectural-view)
7. [Physics and collision architecture](#physics-and-collision-architecture)
8. [Rendering architecture](#rendering-architecture)
9. [Audio, haptics and accessibility](#audio-haptics-and-accessibility)
10. [Where state lives](#where-state-lives)
11. [End-to-end: one scored run](#end-to-end-one-scored-run)
12. [The optional backend](#the-optional-backend)
13. [Database and migrations](#database-and-migrations)
14. [Live leaderboard stream (SSE)](#live-leaderboard-stream-sse)
15. [How the two halves meet](#how-the-two-halves-meet)
16. [Shared contracts and determinism](#shared-contracts-and-determinism)
17. [Configuration surface](#configuration-surface)
18. [Security model (summary)](#security-model-summary)
19. [Failure modes and degradation](#failure-modes-and-degradation)
20. [Observability](#observability)
21. [Docker and runtime topology](#docker-and-runtime-topology)
22. [Build, delivery and CI](#build-delivery-and-ci)
23. [Developer entry points (Make)](#developer-entry-points-make)
24. [Quality and testing](#quality-and-testing)
