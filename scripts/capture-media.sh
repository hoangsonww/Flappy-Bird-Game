...
# The account sheet is backend-independent in UI-test mode, so documentation
# can prove the actual keyboard-safe form without requiring a seeded account.
shoot "account-form" 3   -seed-demo -ui-testing -screen settings -segment 2 -show-account-form
